			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="Public/images/user.png" class="img-circle" alt="Avatar"> <span>${Security.subjectUtil.principle }</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
